...
void PreclustersPostProcessing::createEfficiencyHistos(Trigger t, repository::DatabaseInterface* qcdb)
{
  ...
  mEfficiencyPlotterOnCycle = std::make_unique<EfficiencyPlotter>("Efficiency/OnCycle/", hElecHistoRef, mFullHistos);
  ...
  mEfficiencyTrendsPlotter = std::make_unique<EfficiencyTrendsPlotter>("Trends/", hElecHistoRef);
...
void PreclustersPostProcessing::createClusterChargeHistos(Trigger t, repository::DatabaseInterface* qcdb)
{
  ...
  mClusterChargePlotter = std::make_unique<ClusterChargePlotter>("ClusterCharge/", histoRef);
  mClusterChargePlotter->publish(getObjectsManager());

  mClusterChargePlotterOnCycle = std::make_unique<ClusterChargePlotter>("ClusterCharge/OnCycle/", histoRef);
  ...
  mClusterChargeTrendsPlotter = std::make_unique<ClusterChargeTrendsPlotter>("Trends/", histoRef);
...
void PreclustersPostProcessing::createClusterSizeHistos(Trigger t, repository::DatabaseInterface* qcdb)
{
  ...
  mClusterSizePlotter = std::make_unique<ClusterSizePlotter>("ClusterSize/", histoRef);
  mClusterSizePlotter->publish(getObjectsManager());

  mClusterSizePlotterOnCycle = std::make_unique<ClusterSizePlotter>("ClusterSize/OnCycle/", histoRef);
  ...
  mClusterSizeTrendsPlotter = std::make_unique<ClusterSizeTrendsPlotter>("Trends/", histoRef);
...
void PreclustersPostProcessing::initialize(Trigger t, framework::ServiceRegistryRef services)
{
  ...
  mHistogramQualityPerDE->GetYaxis()->SetBinLabel(1, "Good");
  mHistogramQualityPerDE->GetYaxis()->SetBinLabel(2, "Medium");
  mHistogramQualityPerDE->GetYaxis()->SetBinLabel(3, "Bad");
