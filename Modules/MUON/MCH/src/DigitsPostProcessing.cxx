...
void DigitsPostProcessing::createRatesHistos(Trigger t, repository::DatabaseInterface* qcdb)
{
  ...
  mRatesPlotterOnCycle = std::make_unique<RatesPlotter>("Rates/OnCycle/", hElecHistoRef, mChannelRateMin, mChannelRateMax, mFullHistos);
  ...
  mRatesPlotterSignalOnCycle = std::make_unique<RatesPlotter>("RatesSignal/OnCycle/", hElecSignalHistoRef, mChannelRateMin, mChannelRateMax, mFullHistos);
  ...
  mRatesTrendsPlotter = std::make_unique<RatesTrendsPlotter>("Trends/Rates/", hElecHistoRef);
  mRatesTrendsPlotter->publish(getObjectsManager());

  mRatesTrendsPlotterSignal = std::make_unique<RatesTrendsPlotter>("Trends/RatesSignal/", hElecSignalHistoRef);
...
void DigitsPostProcessing::createOrbitHistos(Trigger t, repository::DatabaseInterface* qcdb)
{
  ...
  mOrbitsPlotterOnCycle = std::make_unique<OrbitsPlotter>("Orbits/OnCycle/");
  ...
  mOrbitsPlotterSignalOnCycle = std::make_unique<OrbitsPlotter>("OrbitsSignal/OnCycle/");
