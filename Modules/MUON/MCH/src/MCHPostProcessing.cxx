...
void MCHPostProcessing::initialize(quality_control::postprocessing::Trigger, o2::framework::ServiceRegistry&)
{
...
void MCHPostProcessing::update(quality_control::postprocessing::Trigger t, o2::framework::ServiceRegistry& services)
{
  auto& qcdb = services.get<o2::quality_control::repository::DatabaseInterface>();
...
void MCHPostProcessing::finalize(quality_control::postprocessing::Trigger t, o2::framework::ServiceRegistry& services)
{
  auto& qcdb = services.get<o2::quality_control::repository::DatabaseInterface>();
...
void MCHPostProcessing::storeTrend(uint64_t timestamp, o2::quality_control::repository::DatabaseInterface& qcdb)
{
...
void MCHPostProcessing::trendValues(uint64_t timestamp, o2::quality_control::repository::DatabaseInterface& qcdb)
{
...
void MCHPostProcessing::storePlots(uint64_t timestamp, o2::quality_control::repository::DatabaseInterface& qcdb)
{
