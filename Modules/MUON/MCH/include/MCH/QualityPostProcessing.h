...
class QualityPostProcessing : public PostProcessingInterface
{
 ...
 private:
  ...
  static std::string digitsSourceName() { return "digits"; }
  static std::string preclustersSourceName() { return "preclusters"; }
  static std::string combinedSourceName() { return "combined"; }

  PostProcessingConfigMCH mConfig;

  // CCDB object accessors
  std::vector<CcdbObjectHelper> mCcdbObjects;
  std::map<std::string, CcdbObjectHelper> mCcdbObjects2;
