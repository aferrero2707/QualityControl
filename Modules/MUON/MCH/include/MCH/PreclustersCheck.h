...
class PreclustersCheck : public o2::quality_control::checker::CheckInterface
{
 ...
 private:
  ...
  std::string mMeanEffHistNameB{ "Efficiency/OnCycle/MeanEfficiencyB" };
  std::string mMeanEffHistNameNB{ "Efficiency/OnCycle/MeanEfficiencyNB" };
  std::string mMeanEffRatioHistNameB{ "Efficiency/OnCycle/MeanEfficiencyRefRatioB" };
  std::string mMeanEffRatioHistNameNB{ "Efficiency/OnCycle/MeanEfficiencyRefRatioNB" };
