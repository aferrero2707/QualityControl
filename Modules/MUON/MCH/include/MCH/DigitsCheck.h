...
class DigitsCheck : public o2::quality_control::checker::CheckInterface
{
 ...
 private:
  ...
  Quality checkFecRate(MergeableTH2Ratio* hr);
  ...
  std::string mFecRateHistName{ "OccupancySignal_Elec" };
  std::string mMeanRateHistName{ "RatesSignal/OnCycle/MeanRate" };
  std::string mMeanRateRatioHistName{ "RatesSignal/OnCycle/MeanRateRefRatio" };
  std::string mBadChanFracHistName{ "RatesSignal/OnCycle/BadChannelsFraction" };
  double mMinRate{ 0.001 };
  double mMaxRate{ 10 };
  double mMaxRateDelta{ 0.2 };
  double mMinGoodFraction{ 0.9 };
  double mMaxEmptyFraction{ 0.3 };
