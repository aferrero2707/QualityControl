...
class DecodingTask /*final*/ : public TaskInterface
{
 ...
 private:
  ...
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsFEC;        ///< error codes per chamber
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsPerDE;      ///< error codes per DE
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsPerChamber; ///< error codes per chamber
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsPerFeeId;   ///< error codes per detection element
  /// \brief histograms up to previously processed cycle
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsPerChamberPrevCycle; ///< error codes per chamber
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsPerFeeIdPrevCycle;   ///< error codes per detection element
  /// \brief histograms from last processed cycle
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsPerChamberOnCycle; ///< error codes per chamber
  std::unique_ptr<MergeableTH2Ratio> mHistogramErrorsPerFeeIdOnCycle;   ///< error codes per detection element
  ...
  std::unique_ptr<MergeableTH1Ratio> mHistogramSynchErrorsPerDE;      ///< fraction of out-of-sync DS boards per detection element
  std::unique_ptr<MergeableTH1Ratio> mHistogramSynchErrorsPerChamber; ///< fraction of out-of-sync DS boards per chamber
