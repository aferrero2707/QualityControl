...
class MCHMIDQcTask final : public TaskInterface
{
 ...
 private:
  ...
  TH1F* mTcRofSizeInTF_MCH{ nullptr };
  TH1F* mTcRofNStationsInTF_MCH{ nullptr };
  TH1F* mTcRofNStations_MCH{ nullptr };
  TH1F* mRofSizeInTF_MCHms{ nullptr };
  TH1F* mRofSizeInOrbit_MID{ nullptr };
  TH2F* mRofSizeInOrbit_MCH{ nullptr };
  TH2F* mDigitsInOrbit_MCH{ nullptr };
};
